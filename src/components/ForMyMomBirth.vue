...
export default {
  mounted() {
    var html = this.$refs.container;
    var sun = this.$refs.sun;
    var rainbow = this.$refs.rainbow;
    var rabbit = this.$refs.rabbit;
    var snow = this.$refs.container.querySelectorAll(".snow");
    var rain = this.$refs.container.querySelectorAll(".rain");
    var flowers = this.$refs.container.querySelectorAll(".flower");
